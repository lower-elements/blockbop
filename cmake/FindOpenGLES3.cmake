# Taken from the Slint project
# Copyright © SixtyFPS GmbH <info@slint.dev>
# SPDX-License-Identifier: GPL-3.0-only OR LicenseRef-Slint-Royalty-free-1.1 OR LicenseRef-Slint-commercial

include(CheckCXXSourceCompiles)

find_path(OPENGLES3_INCLUDE_DIR NAMES "GLES3/gl3.h" "OpenGLES/ES3/gl.h" DOC "The path where the OpenGL ES 2.0 headers are located")
...
if (OPENGLES3_FOUND AND NOT TARGET OpenGL::GLES3)
    add_library(OpenGL::GLES3 UNKNOWN IMPORTED)
    set_property(TARGET OpenGL::GLES3 PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${OPENGLES3_INCLUDE_DIR}")
    set_property(TARGET OpenGL::GLES3 PROPERTY IMPORTED_LOCATION "${OPENGLES3_LIBRARY}")
    if (TARGET OpenGL::EGL)
        target_link_libraries(OpenGL::GLES3 INTERFACE OpenGL::EGL)
    endif()
endif()
